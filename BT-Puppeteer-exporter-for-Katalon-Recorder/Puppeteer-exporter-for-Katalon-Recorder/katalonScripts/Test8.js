...
(async () => {
	...
	await type(`//div[@id='gs_lc0']/input`, `something`);
	await sendKeys(keyDictionary[`\${KEY_ENTER}`]);
	await click(`//div[@id='hdtb-msb-vis']/div[3]/a`);
	await click(`//div[@id='hdtb-msb-vis']/div[4]/a`);
	await click(`//div[@id='hdtb-msb-vis']/div`);
	await click(`//div[@id='hdtb-msb-vis']/div/a`);
	await click(`//div[@id='hdtb-msb']/div[2]/a`);
	await click(`//div[@id='hdtbMenus']/div/div[2]/div`);
	await click(`//li[@id='qdr_y']/a`);
	await click(`//div[@id='hdtbMenus']/div/div[2]/div`);
	await click(`//li[@id='vid_1_dur_l']/a`);
	await click(`//div[@id='hdtbMenus']/div/div[4]/div`);
	await click(`//li[@id='hq_h']/a`);
	await click(`//div[@id='hdtb-msb-vis']/div`);
	await click(`//div[@id='hdtb-msb-vis']/div/a`);
	await open(`https://test.buildertrend.net`);
	await click(`//div[@id='ctl00_ctl00_ctl00_MasterMain_MasterMain_MasterMain_divLoginFormContainer']/div/div[2]/div/input`);
	await type(`//div[@id='ctl00_ctl00_ctl00_MasterMain_MasterMain_MasterMain_divLoginFormContainer']/div/div[2]/div/input`, `nichbuilder`);
	await type(`//div[@id='ctl00_ctl00_ctl00_MasterMain_MasterMain_MasterMain_divLoginFormContainer']/div/div[2]/div[2]/input`, `bt!23`);
	await click(`//div[@id='ctl00_ctl00_ctl00_MasterMain_MasterMain_MasterMain_divLoginFormContainer']/div/div[3]/div[2]/input`);
	await click(`//div[@id='timeClock']/div[2]/div[2]/table/tbody/tr/td[2]/input`);
	await selectFrame(`index=5`);
	await click(`//div[@id='PopupPage']/div/div/div/div/div[2]/div[2]/div[2]/input`);
	await selectFrame(`relative=parent`);
	await click(`//body[@id='ctl00_ctl00_bodyTagControl']/div[18]/div/button/span`);
	await click(`//div[@id='todos']/div[2]/div[2]/div/div[2]/input`);
	await selectFrame(`index=5`);
	await click(`//div[@id='ctl00_ctl00_BaseMain_MainContentHolder_ecToDos_lstJobsites_DropDownList1_chosen']/a/span`);
	await click(`//div[@id='ctl00_ctl00_BaseMain_MainContentHolder_ecToDos_lstJobsites_DropDownList1_chosen']/div/ul/li[4]`);
	await click(`//div[@id='ui-id-1']/div/div/button[2]`);
	await click(`//body[@id='ctl00_ctl00_bodyTagControl']/div[10]/div/button/span`);
	await selectFrame(`relative=parent`);
	await click(`//body[@id='ctl00_ctl00_bodyTagControl']/div[18]/div/button/span`);
	await click(`//a[@id='ctl00_ctl00_BaseMain_ctlMainMenu_ctl06_lnkNewIcon']/span/div`);
	await click(`//a[@id='ctl00_ctl00_BaseMain_ctlMainMenu_ctl06_rptSetupDropDown_ctl00_lnkDropDownMenuItem']/div/div[2]`);
	await click(`//a[@id='ctl00_ctl00_ctl00_BaseMain_ctlMainMenu_ctl09_lnkNewIcon']/span/div`);
	await click(`//a[@id='ctl00_ctl00_ctl00_BaseMain_ctlMainMenu_ctl09_rptSetupDropDown_ctl03_lnkDropDownMenuItem']/div/div[2]`);
