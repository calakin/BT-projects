...
(async () => {
    ...
    //exported test
    await open(`https://buildertrend-interns.slack.com/`);
	await click(`//div[@id='page']/div`);
	await click(`//form[@id='signin_form']/p[3]/input`);
	await type(`//form[@id='signin_form']/p[3]/input`, `cody.lakin@buildertrend.com`);
	await type(`//form[@id='signin_form']/p[4]/input`, `thingstheall32!`);
		await type(`//form[@id='signin_form']/p[4]/input`, `bobthe47`);
		await click(`//div[@id='col_channels_react_root']/nav/div/div/div/div/div/div/div[18]/div/a/span/span`);
	await click(`//div[@id='msg_input']/div/p`);
